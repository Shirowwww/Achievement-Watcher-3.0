...
try {
  ...
  autoUpdater.on('update-available', (info) => debug.log(`[updater] update available: ${info.version}`));
  ...
  app
    .on('ready', async function () {
      ...
      // update-downloaded prompt above. Development runs never contact the release feed.
      if (app.isPackaged) {
        setTimeout(() => {
