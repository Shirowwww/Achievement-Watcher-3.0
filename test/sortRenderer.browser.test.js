...
function buildHarness() {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"></head><body>
    ...
    <script>
      ...
      ${sortScript}
      window.sortFixture = [
        { id: 'a', appid: 10, title: 'Beta', lastplayed: 10, time: 5, percent: 20 },
        { id: 'b', appid: 2, title: 'Alpha', lastplayed: 10, time: 20, percent: 80 },
        { id: 'c', appid: 3, title: 'Gamma', lastplayed: 30, time: 20, percent: 80 },
        { id: 'd', appid: 4, title: 'Delta', lastplayed: 5, time: 40, percent: 10 },
      ];
      window.runSortFixture = (options) => {
        $('#games').html(window.sortFixture.map((game) =>
          '<li data-id="' + game.id + '"><div class="game-box" data-appid="' + game.appid + '" data-lastplayed="' + game.lastplayed + '" data-time="' + game.time + '"></div><div class="info"><span class="title">' + game.title + '</span></div><span class="progressBar" data-percent="' + game.percent + '"></span></li>'
        ).join(''));
